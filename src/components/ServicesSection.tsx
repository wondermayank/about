        ...
        <div className="w-full flex flex-col border-t border-[rgba(12,12,12,0.15)]">
          {SERVICES_DATA.map((service, idx) => (
            <FadeIn
              ...
              y={30}
              as="div"
              className="flex items-center gap-6 sm:gap-10 py-8 sm:py-10 md:py-12 border-b border-[rgba(12,12,12,0.15)] w-full text-left"
            >
              {/* Number Left */}
              <span
                className="font-black text-[#0C0C0C] min-w-[70px] sm:min-w-[120px] md:min-w-[160px] select-none leading-none"
              ...
              <div className="flex flex-col gap-2 sm:gap-3 flex-1">
                ...
                <p
                  className="font-light text-[#0C0C0C] opacity-70 leading-relaxed max-w-2xl"
